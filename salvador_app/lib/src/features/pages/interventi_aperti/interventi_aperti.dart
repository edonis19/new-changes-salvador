...
class InterventiApertiPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    var interventiDbNotifierErp = ref.read(interventiDbRepositoryProvider.notifier);
    var listInterventi = interventiDbNotifierErp.build();
...
void applyFilter({
  ...
  interventi.when(
    data: (data) {
      ...
      ref.read(interventiDbRepositoryProvider.notifier).updateInterventiErp(nuovoInterventoList);
    },
    error: (error, stackTrace) {
    },
    loading: () {
